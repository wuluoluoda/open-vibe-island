...
- Treat `/Users/wuluoluo/work/code.app.org` as the current local testing worktree for the `dev` workstream unless the user names another branch.
...
- Use sibling worktree paths named like `/Users/wuluoluo/work/code.app.org-<topic>`.
...
See [docs/worktree-workflow.md](/Users/wuluoluo/work/code.app.org/docs/worktree-workflow.md) for the concrete commands and lifecycle.
See [docs/tool-versioning.md](/Users/wuluoluo/work/code.app.org/docs/tool-versioning.md) for the local runtime, tag, and rollback workflow.
